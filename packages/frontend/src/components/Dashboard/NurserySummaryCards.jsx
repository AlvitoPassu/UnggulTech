...
const NurserySummaryCards = ({ summary }) => {
  const cards = [
    ...
    { label: "Rata-rata Soil pH", value: summary?.averageSoilPh == null ? "-" : Number(summary.averageSoilPh).toFixed(2), detail: summary?.averageSoilPh == null ? "Data pH belum tersedia" : "Seluruh sensor", icon: FiActivity, color: "text-emerald-700", bg: "bg-emerald-50" },
  ];
