...
var command = {
  ...
  builder(yargs) {
    const opts = {
      c: {
        describe: "Publish packages after every successful merge, appending the sha as a prerelease identifier (e.g. 1.0.1-alpha.0.sha-81e3b44).",
        alias: "canary",
        type: "boolean"
      },
  ...
  async handler(argv) {
    const cmd = await import("./src-E634P2XD.js");
    return (cmd.default ?? cmd)(argv);
  }
};
var command_default2 = command;

export {
  command_default2 as command_default
};
