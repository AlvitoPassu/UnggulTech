...
export declare class Package {
     ...
     */
    get(key: keyof RawManifest): string | boolean | string[] | Record<string, string> | Record<string, unknown> | RawManifestLernaConfig | Record<"registry" | "tag" | "directory", string> | undefined;
    /**
