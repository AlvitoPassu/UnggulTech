...
var command = {
  ...
  builder(yargs, composed) {
    const opts = {
      ...
      "ci-behind-behavior": {
        describe: "Control whether CI errors or exits successfully when the current branch is behind upstream.",
        type: "string",
        choices: ["error", "skip"],
        requiresArg: true,
  ...
  async handler(argv) {
    const cmd = await import("./src-JTMF2QCW.js");
